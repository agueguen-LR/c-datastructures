...
cmake_dependent_option(BUILD_HTML_COVERAGE "Enabling html coverage" OFF
                       "BUILD_COVERAGE;HTML_COVERAGE_EXECUTABLE" OFF)
...
function(enable_html_coverage)
  if(BUILD_HTML_COVERAGE)
    add_custom_target(
      ...
      --sort
      --title
      "${PROJECT_NAME} ${PROJECT_VERSION} Coverage"
      --function-coverage
      --branch-coverage
      --legend
      --quiet
    ...
    add_custom_command(
      ...
      POST_BUILD
      COMMAND echo "HTML coverage is in ${CMAKE_BINARY_DIR}/coverage")
  endif()
